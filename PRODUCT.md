...
## Роли в проекте
**Product Manager** -
формирует видение продукта, приоритеты, определяет что и зачем делать.

**Project Manager** -
следит за сроками, ресурсами и выполнением задач. Фокус на доставке проекта.

**Scrum Master** -
организует Scrum-процессы, устраняет блокеры, следит за эффективностью команды.

**Business Analyst** -
собирает требования от бизнеса, переводит их в понятные задачи для команды.

**System Analyst** -
проектирует архитектуру решений, описывает взаимодействие систем и API.

**Data Analyst** -
паботает с данными: анализ, визуализация, поиск инсайтов для бизнеса.

**ML Engineer** -
анализирует ML модели, ищет лучшую, обучает и настраивает локальные модели.

**Backend-Разработчик** - 
пишет код с бизнес-логикой и связкой с AI-ботами, создаёт pull/merge requests, получает ревью.

**UI/UX Designer** - 
проектирует логику пользовательского пути (UX) и отрисовывает визуальный интерфейс (UI).

**Fontend-Разработчик** - 
берет проекты дизайнеров и пишет frontend.

**Team Lead** - 
проверяет код, принимает решения по merge, следит за качеством.

**DevOps / Администратор Git-платформы** - 
настраивает интеграции, управляет доступами.

**QA Engineer (тестировщик)** -
тестирует продукт, ищет баги, проверяет соответствие требованиям.

**Security Engineer** -
отвечает за безопасность системы: аудит, защита данных, поиск уязвимостей.
...
### Для DevOps:
Как DevOps, я хочу удобный инструмент интеграции системы.

Как DevOps, я хочу управлять доступами, чтобы контролировать безопасность.

### Для компании:
Как компания, я хочу снизить время ревью кода, чтобы ускорить релизы.

Как компания, я хочу централизованное решение, для автоматического реаью кода.

### Общие:
Как пользователь, я хочу видеть историю ревью, чтобы отслеживать изменения.

Как пользователь, я хочу легко привязать систему к любому из своих git-репозиториев.
...
Генерация комментариев в commit'ах

Генерация комментариев в коде

Базовые правила (линтинг + простая логика)

Главная цель: система уже реально помогает ревьюить код
...
| Раздел              | Содержание |
|--------------------|-----------|
| Основные роли               | Developer, Team Lead, UI/UX Designer, DevOps, управление и т.д. |
